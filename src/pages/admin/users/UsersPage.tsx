...
import { Search, Plus, Edit, Trash2, Filter, ArrowUpDown, Eye, Lock, Mail } from "lucide-react";
...
export function UsersPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "blocked":
        return <Badge className="bg-red-500">Bloqué</Badge>;
      default:
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-4">
        ...
        {loading ? (
          <div className="text-center py-10 text-muted-foreground">Chargement des utilisateurs...</div>
        ) : error ? (
